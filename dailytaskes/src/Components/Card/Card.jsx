...
const registerSchema = z.object({
    ...
    password: z.string().nonempty({ message: "Senha não pode ser vazia" }).refine((value) => /^(?=.*[@!#$%^&*()/\\])[@!#$%^&*()/\\a-zA-Z0-9]{8,12}$/.test(value), { message: "Senha deve estar entre 8 e 12 caracters e dev conter ao menos um caracter especial" })
})
